...
namespace Academy.Commands.Creating
{
    public class CreateLectureCommand : ICommand
    {
        ...
        public string Execute(IList<string> parameters)
        {
            ...
            var course = this.engine.Database.Seasons[int.Parse(seasonId)].Courses[int.Parse(courseId)];
            var trainer = this.engine.Database.Trainers.Single(x => x.Username.ToLower() == trainerUsername.ToLower());
